...
class TestForSysAdapter:
    ...
    def test_tissue_frame_to_forsys(self):
        from cellflow.backend.forsys import tissue_frame_to_forsys
...
class TestVisualization:
    ...
    def test_tension_colored_junctions(self):
        from cellflow.utils.mechanics import infer_forces
        from cellflow.frontend.visualization import build_tension_colored_junctions
    ...
    def test_pressure_colored_cells(self):
        from cellflow.utils.mechanics import infer_forces
        from cellflow.frontend.visualization import build_pressure_colored_cells

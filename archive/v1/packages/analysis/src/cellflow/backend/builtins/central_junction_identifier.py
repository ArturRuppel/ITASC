...
from ..api import Source, _resolve_source
from ...utils.structures import EdgeTrajectory, TissueGraphTimeSeries
    ...
    def compute(self, source: Source, **params: Any) -> AnalysisResult:
        ...
        for tissue_id, series in items:
            ...
            for traj in series.edge_trajectories.values():
                # Border junctions are never peripheral — they are unclassified.

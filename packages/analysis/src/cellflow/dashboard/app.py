...
Launch standalone::
    ...
    python -m cellflow.dashboard          # serves at localhost:8050
    python -m cellflow.dashboard /path/to/dataset

Use in Jupyter::

    from cellflow.dashboard import create_app
    app = create_app()
...
from cellflow.utils.io import load_dataset, save_dataset
    ...
    def run_analysis(n_clicks, dataset_path, module_name, param_children, theme_name):
        ...
        try:
            ...
            if module_name == "central_junction_identifier":
                from cellflow.backend.builtins.central_junction_identifier import apply_central_tags

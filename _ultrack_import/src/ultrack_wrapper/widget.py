...
from ultrack_wrapper.widgets import CellposeWidget, FlowGuidedSegmentationWidget, UltrackAnalysisWidget
...
class UltrackWidget(QTabWidget):
    ...
    def __init__(self, napari_viewer: "napari.Viewer") -> None:
        ...
        self.addTab(FlowGuidedSegmentationWidget(napari_viewer), "Flow-Guided Segmentation")

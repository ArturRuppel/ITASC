...
from ..utils.structures import TissueGraphTimeSeries
...
from ..backend.tracking import assign_track_ids
from ..backend.topology import detect_t1_events
from ..utils.io import save_dataset, load_dataset
from ..backend.trajectories import build_edge_trajectories, filter_trajectories
...
class ForceInferenceWorker(QObject):
    ...
    def run(self):
        try:
            from ..backend.forsys import tissue_frame_to_forsys, forsys_results_to_tissue

...
try:  # pragma: no cover - local branch compatibility
    from cellflow.contact_analysis.contacts.reader import read_position_contacts
    ...
    def read_position_contacts(*_args, **_kwargs):  # type: ignore[no-redef]
        raise ImportError("cellflow.contact_analysis.contacts.reader is unavailable")

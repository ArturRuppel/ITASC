...
modules under :mod:`cellflow.contact_analysis.quantifiers` without
touching the studio.

The mechanics mirror :mod:`cellflow.napari.contact_analysis.plugins`: subclassing with a
...
class Quantifier:
    ...
    #: **aggregated**: :mod:`cellflow.contact_analysis.shape_tables` pools it

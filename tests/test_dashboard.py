...
from napariTissueGraph.core.io import save_dataset
...
class TestDashAppCreation:
    def test_create_app_no_dataset(self):
        from napariTissueGraph.dashboard.app import create_app
        app = create_app()
...
class TestWidgetMapping:
    def test_int_param(self):
        from napariTissueGraph.dashboard.app import _make_input
        from napariTissueGraph.analysis.modules import Parameter, ParamType
    ...
    def test_read_bool_value(self):
        from napariTissueGraph.dashboard.app import _read_widget_value
        from napariTissueGraph.analysis.modules import Parameter, ParamType
        p = Parameter(name="flag", label="Flag", type=ParamType.BOOL, default=True)
...
class TestParamExtraction:
    def test_extract_params_from_children(self):
        from napariTissueGraph.dashboard.app import _extract_params_from_children
        from napariTissueGraph.analysis.modules import Parameter, ParamType

...
from cellflow.contact_analysis.plotting import (
    DISTRIBUTION_PLOTS,
    PLOT_OPTIONS,
    UNCLASSIFIED,
    PlotSpec,
...
def test_plot_options_covers_every_plot_type():
    from cellflow.contact_analysis.plotting import _PLOTS
...
def test_axis_limits_default_to_auto():
    from cellflow.contact_analysis.plotting import StyleSpec
    s = StyleSpec()
...
from cellflow.contact_analysis.plotting import _PICK_ROWS_ATTR  # noqa: E402
...
def test_potential_inverts_the_shape_reduced_table_like_distributions():
    ...
    from cellflow.contact_analysis.plotting import reduce_to_units
    from cellflow.contact_analysis.reduce import Collapse
...
def test_plotted_table_distribution_is_per_unit_values():
    from cellflow.contact_analysis.plotting import plotted_table
...
def test_hist_bins_raw_rows_no_hidden_collapse():
    ...
    from cellflow.contact_analysis.plotting import plotted_table, summary_table
...
def test_plotted_table_bar_is_the_aggregate():
    from cellflow.contact_analysis.plotting import aggregate, plotted_table
...
def test_plotted_table_potential_is_the_curve():
    from cellflow.contact_analysis.plotting import plotted_table, potential_table

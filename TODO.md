...
- [ ] Reorganize database browser summary statistics: they are currently chained into one string separated with `|`, and the text does not fit its container, causing top and bottom clipping.
